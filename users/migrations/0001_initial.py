# Generated by Django 5.2 on 2025-06-06 16:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exits. '}, help_text='Required. 30 characters or fewer starting with a letter. letters,digits and @/./+/_ only.', max_length=32, unique=True, validators=[django.core.validators.RegexValidator('^[a-za-z][a-zA-Z0-9_\\.]+$', 'Enter a valid username starting with a-z.This value may contain only letters, numbers and underscore characters. ', 'invalid')], verbose_name='username')),
                ('first_name', models.CharField(blank=True, max_length=30, verbose_name='first name')),
                ('last_name', models.CharField(blank=True, max_length=30, verbose_name='last name')),
                ('email', models.CharField(blank=True, null=True, unique=True, verbose_name='email address')),
                ('phone_number', models.BigIntegerField(blank=True, error_messages={'unique': 'A user with that username already exits.'}, null=True, unique=True, validators=[django.core.validators.RegexValidator('^989[0-,9\\d{8}&', 'Enter a valid mobile number. ')], verbose_name='mobile number')),
                ('is_staff', models.BooleanField(default=False, help_text='Designates whether the user can log into this admin site.', verbose_name='staff status')),
                ('is_active', models.BooleanField(default=True, help_text='Designates whether the user can log into this admin site.Unselect this instead of deleting acounts', verbose_name='active')),
